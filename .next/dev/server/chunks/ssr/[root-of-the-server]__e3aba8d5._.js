...
function MainPageClient({ featuredProjects, allProjects, siteSettings }) {
    ...
    // Check if returning from video player (has section param)
    const returnSection = searchParams.get('section');
    const isReturning = returnSection !== null;
    // Determine initial section based on return param
    const initialSection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (returnSection === 'archive') return featuredProjects.length // Archive is last section
        ;
        const sectionIndex = parseInt(returnSection, 10);
        return isNaN(sectionIndex) ? 0 : sectionIndex;
    }, [
        returnSection,
        featuredProjects.length
    ]);
    // Show splash only on first visit (not when returning from video player)
    const [showSplash, setShowSplash] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(!isReturning);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3aba8d5._.js.map